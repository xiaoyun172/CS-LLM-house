...
export class AssistantService {
  ...
  // 迁移相关功能
  static checkAndMigrateOnStartup = MigrationManager.checkAndMigrateOnStartup;
  static migrateToDesktopStructure = MigrationManager.migrateToDesktopStructure;
  static getDesktopStructureAssistants = MigrationManager.getDesktopStructureAssistants;
  static saveDesktopAssistant = MigrationManager.saveDesktopAssistant;
