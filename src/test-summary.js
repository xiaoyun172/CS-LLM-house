...
var NewsSummaryGenerator_1 = require("./shared/utils/NewsSummaryGenerator");
// 创建一些模拟的搜索结果
var mockResults = [
    {
        id: '1',
...
// 生成简单摘要
console.log('=== 简单新闻摘要 ===');
console.log((0, NewsSummaryGenerator_1.generateNewsSummary)(mockResults));
console.log('\n\n');
// 生成详细摘要
console.log('=== 详细新闻摘要 ===');
console.log((0, NewsSummaryGenerator_1.generateDetailedNewsSummary)(mockResults));
